<template>
  <a-card :loading="loading">
        ...
        <a-row :gutter='48'>
          <a-col :md="12" :sm="12">
            ...
            <a-form-item aria-label="日期">
              <a-date-picker v-model="date" style="width: 100%" placeholder="日期"
    ...
    <div style="width: 100%; height: 400px;">
      <bms-chart-component ref="voltageChart" :deviceId="deviceId" :title="voltageCurrentCapacityTitle"
        :ylabel="voltageCurrentCapacityYLabel" :chartData="voltageCurrentCapacityData" />
    </div>
    <div style="width: 100%; height: 400px;">
      <bms-chart-component ref="temperatureChart" :deviceId="deviceId" :title="temperatureTitle"
        :ylabel="temperatureYLabel" :chartData="temperatureData" />
    </div>
    <div style="width: 100%; height: 400px;">
      <bms-chart-component ref="singleBatteryVoltageChart" :deviceId="deviceId" :title="singleBatteryVoltageTitle"
        :ylabel="singleBatteryVoltageYLabel" :chartData="singleBatteryVoltageData" />
    </div>
  </a-card>
</template>
<script>
