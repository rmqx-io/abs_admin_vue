<template>
  <a-modal
    :title="model && model.id ? '编辑智能开关型号' : '新增智能开关型号'"
    :width="800"
    :visible="visible"
  ...
  >
    <a-form :form="form" :label-col="{ span: 6 }" :wrapper-col="{ span: 16 }">
      ...
      <a-row :gutter="24">
        <a-col :span="12">
          <a-form-item label="开关数量">
            <a-input-number
              v-decorator="['switch_count', {
                rules: [{ required: true, message: '请输入开关数量' }],
                initialValue: 1
              }]"
              placeholder="开关数量"
              min="1"
